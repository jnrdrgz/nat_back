...
exports.deleteCiclo = asyncHandler(async (req, res, next) => {
    let cicl = await Ciclo.findByPk(req.body.id, {
        attributes: [
          "id",
          "fechaInicio",
          "fechaFin",
    ...
    cicl.estaEliminado = true;
    await cicl.save()

    return res.status(200).json({ success: true, data: cicl });
})
